...
| HTML 파일 다운로드 | [HTML ZIP](https://github.com/chungheonLee0325/FishingIsGood/releases/download/v0.1.1/FishingIsGood-HTML.zip) |
| Windows x64 실행 파일 | [Windows ZIP](https://github.com/chungheonLee0325/FishingIsGood/releases/download/v0.1.1/FishingIsGood-Windows-x64.zip) |
| 릴리스 / 파일 검증값 | [v0.1.1](https://github.com/chungheonLee0325/FishingIsGood/releases/tag/v0.1.1) |
